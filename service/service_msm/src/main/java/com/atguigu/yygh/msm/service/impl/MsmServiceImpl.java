...
public class MsmServiceImpl implements MsmService {
    ...
    private static String from = "13101282624@163.com";// 发件人的邮箱地址
    private static String user = "13101282624@163.com";// 发件人称号，同邮箱地址
    private static String password = "FIICQEGKFHWWFZCR";// 发件人邮箱的授权码
